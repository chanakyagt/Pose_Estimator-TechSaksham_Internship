...
def sidebar_ui():
    ...
    st.sidebar.markdown("""
        ...
        Pose estimation detects human body keypoints in images or videos.
        - **Applications:**
            - Fitness Tracking
...
def main():
    ...
    st.markdown("**Analyze human poses using advanced AI-based techniques.**")

    uploaded_file = sidebar_ui()
    if uploaded_file:
